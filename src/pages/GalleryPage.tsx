      ...
      <main className="mx-auto max-w-7xl px-6 py-14">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {GALLERY_ITEMS.map((item) => (
            ...
            >
              <div className={`h-56 bg-gradient-to-br ${item.imageBg} p-6 flex flex-col justify-between border-b border-charcoal/8 relative overflow-hidden`}>
                <div className="flex items-center justify-between">
                  <span className="rounded-full border border-white/80 bg-white/70 backdrop-blur-md px-3 py-1 font-mono text-[10px] font-bold uppercase text-charcoal shadow-glass">
                    {item.category}
                  </span>
                ...
                <div className="flex items-center justify-center">
                  <span className="flex h-14 w-14 items-center justify-center rounded-2xl border border-white/80 bg-white/70 backdrop-blur-md text-charcoal group-hover:scale-110 shadow-glass transition-transform">
              ...
              <div className="p-5">
                <h3 className="font-display text-xl font-bold uppercase text-charcoal group-hover:text-neon transition-colors">
                  {item.title}
                </h3>
              </div>
            </div>
